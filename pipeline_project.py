...
def assemble_transcripts(cwd):
    ...
    command = 'rnaspades.py --pe-1 1 '+files[0]+' --pe-2 1 '+files[1]+' --pe-1 2 '+files[2]+' --pe-2 2 '+files[3]+' --pe-1 3 '+files[4]+' --pe-2 3 '+files[5]+' --pe-1 4 '+files[6]+' --pe-2 4 '+files[7]+' -o '+output_path
