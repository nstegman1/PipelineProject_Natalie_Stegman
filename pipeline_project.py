...
def blast(cwd):
    ...
    handle = Entrez.esearch(db = "nucleotide", term = ("Betaherpesvirinae[Organism] OR Betaherpesvirinae[All Fields] AND refseq[filter]"), retmax = 50) 
    ...
    blast_command = 'blastn -query '+query_path+' -db '+output_db+" -num_threads 2 -max_hsps 1 -max_target_seqs 10 -out "+output_path+" -outfmt='7 sacc pident length qstart qend sstart send bitscore evalue stitle'"
    print(blast_command)
